...
const valid = { name: "Orders", description: "", provider_id: "123e4567-e89b-12d3-a456-426614174000", model: "fast", system_prompt: "", temperature: 0.5, max_output_tokens: 1024, context_window_tokens: 32768, max_iterations: 8, timeout_seconds: 120 };
