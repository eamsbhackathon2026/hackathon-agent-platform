...
export const navItems: NavItem[] = [
  ...
  { label: "Agent Hub", description: "Create an assistant for each workflow and test it when it is ready.", to: "/agents", icon: Bot },
  { label: "Playground", description: "Send a request and follow the response in real time.", to: "/playground", icon: MessageSquareText },
  { label: "Conversation History", description: "Follow each conversation turn by turn, with status, timing, and the agent loop behind every answer.", to: "/conversations", icon: History },
