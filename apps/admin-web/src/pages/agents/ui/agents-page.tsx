...
export function AgentsPage() {
  ...
  return <main className="space-y-6">{canEdit ? <div className="flex justify-end"><Button asChild><Link to="/agents/new"><Plus />Create assistant</Link></Button></div> : null}{!canEdit ? <p className="text-sm text-muted-foreground">Only administrators can edit assistants. Contact an administrator for help.</p> : null}
